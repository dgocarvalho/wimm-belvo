...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php 
                                                    $balance = $db->getCurrentBalance($_SESSION['user_id']);
                                                    if (!empty($balance)) {
                                                        echo $balance[0]['current_balance'] . ' ' . $balance[0]['currency'];
                                                    } else {
                                                        echo "0.00";
                                                    }
                                                ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                TOTAL OF ACCOUNTS</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $db->getTotalAccounts($_SESSION['user_id']) ?></div>
                                        </div>
                                        <div class="col-auto">
    ...
    <script type="text/javascript">
        ...
        data: {
            labels: [
                <?php
                    $balance = $db->getAllBalance($_SESSION['user_id']);
                    $labels = "";

                    foreach ($balance as $row) {
                        if ($labels == '')  {
                            $labels = $labels . "'" . $row["value_date"]. "'" ;
                        } else {
                            $labels = $labels . ",'" . $row["value_date"]. "'" ;
                        }
